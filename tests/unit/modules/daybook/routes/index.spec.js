...
describe('Pruebas en el router module del Daybook', () => {
  test('el router debe de tener esta configuracion', async () => {
    //pruebo que traiga esta misma forma
    ...
    //EntryView NoEntrySelected
    // expect((await daybookRouter.children[0].component()).default.name).toBe(
    //   'NoEntrySelected',
    // )
    //expect((await daybookRouter.children[1].component()).default.name).toBe('EntrySelected')
    //en esto veo si carga el componente
    const promiseRoutes = []
